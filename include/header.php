<?php
/**
 * Echo out a reusable header that can be used on different pages of the web system to include different
...
<!-- Chart.JS 2.8.0 -->
<script src="assets/vendor/chartjs/chart.js" type="text/javascript"></script>
